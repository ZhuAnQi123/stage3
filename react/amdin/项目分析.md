...
团队合作工具  tower：https://tower.im/ 钉钉 企业微信 语雀 飞书
...
#### react脚手架的搭建
 cd 拖母文件夹形成路径
 create-react-app 项目文件名
 cd \          ----这条cd不一定，选到你git的文件下
 git add .     ----先做git提交
 git commit -m '脚手架搭建'
 cd 项目文件名
 npm run eject ----选y
...
####  react-admin 项目启动
使用antd框架矿建react----https://ant.design/index-cn
antd-pro 来做管理平台
ui框架 antd 
前端框架 react
网络请求 axios 
...
#### 样式 less
 ...
 修改webpack.config.js 找 babel-loader 下的plugins👇添加“import”那行代码
 babel-loader 
 "plugins": [
    ....,
    ["import", {'libraryName':'antd',style:true}]
 ]
 如果有报错将less的版本回退到2.7.3 
